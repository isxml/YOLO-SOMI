...
YOLO_LABELS_PATH = "datasets/VisDrone/VisDrone2019-DET-test-dev/labels"
VISANN_PATH = "datasets/VisDrone/VisDrone2019-DET-test-dev/annotations/"
VISIMG_PATH = "datasets//VisDrone/VisDrone2019-DET-test-dev/images/"
